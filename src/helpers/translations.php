...
function learning_app_translations(): array
{
    return [
        'en' => [
            ...
            'exercise.type.add' => 'Addition',
            'exercise.type.subtract' => 'Subtraction',
            'exercise.type.multiply' => 'Multiplication',
            'exercise.type.divide' => 'Division',
            'exercise.type.missing_addend' => 'Missing addend',
            'exercise.type.percent_of' => 'Percentage',
            'exercise.type.square' => 'Square number',
            'exercise.type.fraction' => 'Fractions',
            'exercise.type.decimal' => 'Decimals',
            'exercise.hint.add' => 'Both addends are drawn from the range.',
            'exercise.hint.subtract' => 'The second number is never larger than the first, so the answer is never negative.',
            'exercise.hint.multiply' => 'Both factors are drawn from the range.',
            'exercise.hint.divide' => 'Divisor and answer are drawn from the range; the division always comes out even.',
            'exercise.hint.missing_addend' => 'The first addend and the sum are drawn from the range; the answer is the second addend.',
            'exercise.hint.percent_of' => 'The base is drawn from the range, the percentage is 5, 10, 20, 25, 50 or 75.',
            'exercise.hint.square' => 'The number is drawn from the range and multiplied by itself.',
            'exercise.hint.fraction' => 'The denominator is 2, 3, 4, 5, 6, 8, 10 or 12; the numerators come from the range and stay below it.',
            'exercise.hint.decimal' => 'The whole part is drawn from the range, plus one decimal place from 1 to 9.',
            // --- The map of a card ---
        ...
        'de' => [
            ...
            'exercise.type.add' => 'Addition',
            'exercise.type.subtract' => 'Subtraktion',
            'exercise.type.multiply' => 'Multiplikation',
            'exercise.type.divide' => 'Division',
            'exercise.type.missing_addend' => 'Fehlender Summand',
            'exercise.type.percent_of' => 'Prozentwert',
            'exercise.type.square' => 'Quadratzahl',
            'exercise.type.fraction' => 'Brüche',
            'exercise.type.decimal' => 'Dezimalzahlen',
            'exercise.hint.add' => 'Beide Summanden kommen aus dem Bereich.',
            'exercise.hint.subtract' => 'Die zweite Zahl ist nie größer als die erste, das Ergebnis also nie negativ.',
            'exercise.hint.multiply' => 'Beide Faktoren kommen aus dem Bereich.',
            'exercise.hint.divide' => 'Teiler und Ergebnis kommen aus dem Bereich; die Division geht immer auf.',
            'exercise.hint.missing_addend' => 'Erster Summand und Summe kommen aus dem Bereich; gesucht ist der zweite Summand.',
            'exercise.hint.percent_of' => 'Der Grundwert kommt aus dem Bereich, der Prozentsatz ist 5, 10, 20, 25, 50 oder 75.',
            'exercise.hint.square' => 'Die Zahl kommt aus dem Bereich und wird mit sich selbst malgenommen.',
            'exercise.hint.fraction' => 'Der Nenner ist 2, 3, 4, 5, 6, 8, 10 oder 12; die Zähler kommen aus dem Bereich und bleiben darunter.',
            'exercise.hint.decimal' => 'Der ganze Teil kommt aus dem Bereich, dazu eine Nachkommastelle von 1 bis 9.',
